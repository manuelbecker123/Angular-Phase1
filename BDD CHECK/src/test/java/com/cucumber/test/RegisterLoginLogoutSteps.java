...
public class RegisterLoginLogoutSteps {
   ...
   // private ScreenRecordUtil recorder;
    private Actions actions;  // Declare Actions object for mouse interaction

    @Before
    public void setUp() throws IOException {
        // Start the screen recording
       // recorder = new ScreenRecordUtil();
        //recorder.startRecording("C:\\Users\\Marie-C. Becker\\Desktop\\test_recording.mp4");  // Specify the output file name

        // Set up WebDriver (Make sure the path is correct)
    ...
    public void i_fill_in_the_registration_form_with_valid_details(DataTable table) {
        ...
        // Slow down actions to make it smoother
        slowDown(500); 
        ...
        slowDown(500);
        actions.moveToElement(repeatPasswordElement).perform();
        repeatPasswordElement.sendKeys(repeatPassword);

        slowDown(500);
        actions.moveToElement(phoneNumberElement).perform();
    ...
    public void i_submit_the_registration_form() {
        ...
        // Slow down the click for smoothness
        slowDown(500);
        
        // Move the mouse to the submit button and click
    ...
    public void i_enter_the_registered_email_and_password(DataTable table) {
        ...
        slowDown(500);
        actions.moveToElement(loginEmail).perform();
        loginEmail.sendKeys(email);

        slowDown(500);
        actions.moveToElement(loginPassword).perform();
    ...
    public void i_book_a_meeting_with_valid_details(DataTable table) {
        ...
        // Fill in the meeting details with smooth actions
        slowDown(500);
        actions.moveToElement(meetingDateElement).perform();
        meetingDateElement.sendKeys(meetingDate);

        slowDown(500);
        actions.moveToElement(startTimeElement).perform();
        ...
        slowDown(500);
        actions.moveToElement(numPeopleElement).perform();
        numPeopleElement.sendKeys(numPeople);

        slowDown(500);
        actions.moveToElement(descriptionElement).perform();
        descriptionElement.sendKeys(description);

        slowDown(500);
        actions.moveToElement(durationElement).perform();
    ...
    public void i_delete_a_meeting() {
        ...
        String meetingId = "65";  // Replace with how you get the meeting ID
    ...
    public void i_enter_my_email_into_the_subscription_form_and_submit_it() {
        ...
        String emailToSubscribe = "email3@example.com";  // Replace with the actual email you want to test with
    ...
    // Helper method to introduce a small delay between actions
